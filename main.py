...
st.markdown("Upload your resume and get AI-powered feedback on your skills and experience.")
...
def extract_text_from_file(upload_file):
    ...
    return upload_file.getvalue().decode("utf-8")
